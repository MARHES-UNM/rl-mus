...
def train(args):
    ...
    args.config["safety_layer_cfg"]["num_epochs"] = tune.grid_search([500])
    args.config["safety_layer_cfg"]["lr"] = 5e-4
    args.config["safety_layer_cfg"]["eps_safe"] = 0.001
    args.config["safety_layer_cfg"]["eps_dang"] = tune.grid_search([0.001, 0.05])
    ...
    args.config["env_config"]["t_go_n"] = tune.grid_search([1.0])
