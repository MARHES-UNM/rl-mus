...
def train(args):
    ...
    args.config["env_config"]["obstacle_collision_weight"] = 50
    args.config["env_config"]["uav_collision_weight"] = 50
    args.config["env_config"]["crash_penalty"] = 50
    ...
    args.config["env_config"]["stp_penalty"] = tune.grid_search([8, 5, 9, 10])
