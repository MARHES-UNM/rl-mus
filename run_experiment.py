...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-31-00-41_c24ddfc/n_col_n_preload/PPO_multi-uav-sim-v0_cc208_00009_9_beta=0.3000,d_thresh=0.0100,obstacle_collision_weight=0.0000,tgt_reward=0.0000,uav_collision_we_2023-10-31_00-41-46/checkpoint_000365",
    )
