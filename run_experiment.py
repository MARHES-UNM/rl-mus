...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-12-50_af3594d/simple_reward/PPO_multi-uav-sim-v0_17364_00000_0_beta=0.0100,d_thresh=0.2000,dt_reward=200.0000,obstacle_collision_weight=0.1000,stp_penalty=100_2023-10-28_12-50-24/checkpoint_000165"
    )
