...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-29-08-39_5728d09/test_lower_beta/PPO_multi-uav-sim-v0_271bd_00000_0_beta=0.1000,d_thresh=0.0100,obstacle_collision_weight=0.0000,uav_collision_weight=0.0000,use_sa_2023-10-29_08-39-08/checkpoint_000330",
    )
