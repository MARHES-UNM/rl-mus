...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-22-40_df49a29/low_dt_thresh/PPO_multi-uav-sim-v0_91292_00000_0_beta=0.0100,d_thresh=0.0100,obstacle_collision_weight=1.0000,uav_collision_weight=1.0000,use_sa_2023-10-28_22-40-48/checkpoint_000080",
    )
