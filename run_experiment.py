...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-14-58_e18753c/vel_penalty/PPO_multi-uav-sim-v0_fdd3f_00000_0_beta=0.0100,d_thresh=0.2000,dt_reward=200.0000,obstacle_collision_weight=0.0000,stp_penalty=100_2023-10-28_14-58-33/checkpoint_000085",
    )
