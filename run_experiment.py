...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-29-14-34_05d3c4a/beta_1_col_pen/PPO_multi-uav-sim-v0_d7bd9_00001_1_beta=0.5000,d_thresh=0.0100,obstacle_collision_weight=1.0000,uav_collision_weight=1.0000,use_sa_2023-10-29_14-34-49/checkpoint_000453",
    )
