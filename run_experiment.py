...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-27-21-06_9729f12/dt_go_penalty/PPO_multi-uav-sim-v0_357b5_00001_1_beta=0.0100,d_thresh=0.2000,dt_go_penalty=10.0000,dt_reward=200.0000,obstacle_collision_weight=_2023-10-27_21-06-22/checkpoint_000210",
    )
