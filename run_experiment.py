...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-29-12-37_4e352d4/beta_0_5/PPO_multi-uav-sim-v0_83d8b_00000_0_beta=0.5000,d_thresh=0.0100,obstacle_collision_weight=0.0000,uav_collision_weight=0.0000,use_sa_2023-10-29_12-37-57/checkpoint_000160",
    )
