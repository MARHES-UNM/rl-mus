...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-17-26_e989808/troubleshoot/PPO_multi-uav-sim-v0_9e3c0_00001_1_beta=0.0100,d_thresh=0.0100,obstacle_collision_weight=0.0000,tgt_reward=100,uav_collision_weigh_2023-10-28_17-26-12/checkpoint_000075",
    )
