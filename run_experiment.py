...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-10-02_1d94c9c/norm_action/PPO_multi-uav-sim-v0_afba1_00000_0_beta=0.0100,d_thresh=0.2000,dt_go_penalty=1.0000,dt_reward=200.0000,obstacle_collision_weight=0_2023-10-28_10-02-52/checkpoint_000130",
    )
