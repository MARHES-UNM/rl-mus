...
def experiment(exp_config={}, max_num_episodes=1, experiment_num=0):
    ...
    checkpoint = exp_config.get(
        ...
        "/home/prime/Documents/workspace/rl_multi_uav_sim/results/PPO/multi-uav-sim-v0_2023-10-28-19-37_9acf4bd/negative_reward/PPO_multi-uav-sim-v0_fa94c_00001_1_beta=0.0010,d_thresh=0.2000,obstacle_collision_weight=0.0000,tgt_reward=100.0000,uav_collision__2023-10-28_19-37-38/checkpoint_000155",
    )
