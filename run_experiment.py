...
def train(args):
    ...
    args.config["env_config"]["obstacle_collision_weight"] = 0
    args.config["env_config"]["uav_collision_weight"] = 0
    args.config["env_config"]["crash_penalty"] = 0
    ...
    args.config["env_config"]["tgt_reward"] = tune.grid_search([0, 100])
    args.config["env_config"]["sa_reward"] = 100
    args.config["env_config"]["beta"] = 0.0
